    ...
    <ErrorBoundary>
      ...
      <Routes>
        ...
        <Route element={<AppLayout />}>
          ...
          <Route path="/pipeline" element={<Suspense><Pipeline /></Suspense>} />
          <Route path="/leads" element={<Suspense><Leads /></Suspense>} />
          <Route path="/leads/:id" element={<Suspense><LeadDetail /></Suspense>} />
