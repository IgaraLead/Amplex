...
from app.models import Activity, Lead, Interaction

router = APIRouter(prefix="/amplex/api/crm", tags=["notifications"])
...
def list_notifications(
    ...
    for act in activities:
        ...
        items.append({
            ...
            "state": "overdue" if is_overdue else ("today" if is_today else "planned"),
    ...
    if activity.lead_id:
        ...
        if lead:
            ...
            interaction = Interaction(
                ...
                body=f'<p>✅ <strong>Atividade concluída</strong>: {activity.summary or "Retorno"}</p>{feedback_html}',
